...
public class RecordCommand {
    ...
    private static int setDay(CommandContext<ServerCommandSource> context) {
        ...
        context.getSource().sendFeedback(Text.of(I18n.translate("set_day", value)), true);
    ...
    private static int setDayWithTarget(CommandContext<ServerCommandSource> context) throws CommandSyntaxException {
        ...
        context.getSource().sendFeedback(Text.of(I18n.translate("set_day_with_target", target.getEntityName(), value)), true);
    ...
    private static int setRecordDay(CommandContext<ServerCommandSource> context) {
        ...
        context.getSource().sendFeedback(Text.of(I18n.translate("set_record_day", value)), true);
    ...
    private static int setRecordDayWithTarget(CommandContext<ServerCommandSource> context) throws CommandSyntaxException {
        ...
        context.getSource().sendFeedback(Text.of(I18n.translate("set_record_day_with_target", target.getEntityName(), value)), true);
